...
// ROCmForge Seed 2: Tiled Matmul — Compute + shared memory
...
//
// After successful port, the swarm profiles with amd-smi during the hot kernel
...
int main(int argc, char** argv) {
  ...
  printf("ROCmForge tiledMatmul seed\n");
