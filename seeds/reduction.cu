// seeds/reduction.cu
// ROCmForge Seed 3: Parallel Reduction — Control flow, synchronization & atomics
...
// Target: Demonstrate solid occupancy + any repair loops the Porting Specialist needs
// for atomics or shared memory patterns on gfx942.
...
int main(int argc, char** argv) {
  ...
  printf("ROCmForge reduction seed\n");
  printf("Elements: %zu\n", n);
