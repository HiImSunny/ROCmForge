// seeds/vectorAdd.cu
// ROCmForge Seed 1: vectorAdd — Memory bandwidth hero
// Self-contained CUDA example for CUDA → HIP autonomous porting.
// Target: High % of MI300X 5.3 TB/s HBM3 theoretical peak.
//
// This file + minimal host driver is the complete input for the swarm.
// After hipify + hipcc + run on real MI300X, the baseline/agents capture
// amd-smi metrics and compute achieved BW + efficiency %.
...
int main(int argc, char** argv) {
  ...
  printf("ROCmForge vectorAdd seed\n");
